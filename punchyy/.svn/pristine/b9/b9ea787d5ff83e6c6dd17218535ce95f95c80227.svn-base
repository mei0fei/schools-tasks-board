...
public class UserWindow extends JFrame {
	...
	public UserWindow(User user) {
		...
		JLabel lblNewLabel_1 = new JLabel("”√ªß√˚");
		...
		JLabel lblNewLabel_3 = new JLabel("µÁ  ª∞");
		...
		JLabel lblNewLabel_5 = new JLabel("À˘‘⁄µÿ");
		...
		lblNewLabel_6 = new JLabel("”‡  ∂Ó");
		lblNewLabel_6.setBounds(46, 155, 54, 18);
		lblNewLabel_6.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
...
//		}).start();
		...
		btnNewButton_1 = new JButton("Ã·œ÷");
		...
		btnNewButton_2 = new JButton("–ﬁ∏ƒ√‹¬Î");
		...
		JButton btnNewButton_3 = new JButton("∑µ  ªÿ");
		btnNewButton_3.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
